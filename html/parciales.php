...
<div class="containerexam">
    <div class="parciales">
            <div class="div_parciales">
                    <h4>Parciales Antiguos</h4>
                <div class="div_parciales_uno">
                    <a href="../parciales/PRIMER PARCIAL DE MATEMÁTICA tema 1.pdf">TEMA 1</a>
                    <span>Primer Parcial 2022</span>
                    <button type="button" class="btn btn-light"><a>Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="../parciales/PRIMER PARCIAL DE MATEMÁTICA tema 2.pdf">TEMA 2</a>
                    <span>Primer Parcial 2022</span>
                    <button type="button" class="btn btn-light"><a>Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="../parciales/PRIMER PARCIAL DE MATEMÁTICA tema 3.pdf">TEMA 3</a>
                    <span>Primer Parcial 2022</span>
                    <button type="button" class="btn btn-light"><a>Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="../parciales/PRIMER PARCIAL DE MATEMÁTICA tema 4.pdf">TEMA 4</a>
                    <span>Primer Parcial 2022</span>
                    <button type="button" class="btn btn-light"><a>Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="../parciales/GUÍA DE REPASO - FUNCIONES Y MATRICES.pdf">TEMA 1</a>
                    <span>Segundo Parcial 2022</span>
                    <button type="button" class="btn btn-light"><a>Resolución</a></button>
                </div>
            </div>
    </div>   
    <div class="finales">
        <div class="div_parciales">
                    <h4>Finales Antiguos</h4>
                <div class="div_parciales_uno">
                    <a href="http://">TP1</a>
                    <span>Final Matemática 2021</span>
                    <button type="button" class="btn btn-light"><a >Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="http://">TP1</a>
                    <span>Final Ingles 2022</span>
                    <button type="button" class="btn btn-light"><a >Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="http://">TP1</a>
                    <span>Final Algoritmo 2022</span>
                    <button type="button" class="btn btn-light"><a >Resolución</a></button>
                </div>
                <div class="div_parciales_uno">
                    <a href="http://">TP1</a>
                    <span>Final Base de Datos 2022</span>
                    <button type="button" class="btn btn-light"><a >Resolución</a></button>
                </div>
        </div>
    </div>
