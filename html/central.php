   ...
   <header>
    <!--Buscador-->
       <div class="textos_titulo">
          <h1>Bienvenidos a la Biblioteca en línea</h1>
       </div>
  <container id="buscadorPro">
       <div>
          <h2 style="font-family: 'Gentium Book Plus', serif;">Busca tu libro</h2>
       </div>
      <div>
        ...
        <div class="row">
            <div class="card col-xs-12 col-md-6 col-sm-6 col-lg-3 col-xl-3" id="divtarjeta">
                <div class="head">
                    ...
                    <div class="img">
                        <img src="../galeria/tarjeta-face/juanjo.jpeg" alt="">
                      </div>
                </div>
                ...
                <div class="contact">
                    <a href="https://www.instagram.com/jj.brunelli616/">Más Info</a>
                </div>
            </div>
            <!--2-->
            <div class="card col-xs-12 col-md-6 col-sm-6 col-lg-3 col-xl-3" id="divtarjeta">
                <div class="head">
                    <div class="circle"></div>
                    <div class="img">
                        <img src="../galeria/tarjeta-face/monte.jpeg" alt="">
                    </div>
                </div>
                <!--Infomarcion del libro-->
                <div class="descripcion">
                    <h3>Montellano Marcos</h3>
                    <h4>Administrador</h4>
                </div>
                    <!--boton para ir al link del libro-->
                <div class="contact">
                    <a href="https://www.instagram.com/montellanomarcos/">Más Info</a>
                </div>
            </div>
            <!--3-->
            <div class="card col-xs-12 col-md-6 col-sm-6 col-lg-3 col-xl-3" id="divtarjeta">
                <div class="head">
                    <div class="circle"></div>
                    <div class="img">
                        <img src="../galeria/tarjeta-face/Chantix.jpg" alt="">
                    </div>
                </div>
                <!--Infomarcion del libro-->
                <div class="descripcion">
                    <h3>Recalde Agustin</h3>
                    <h4>Administrador</h4>
                </div>
                    <!--boton para ir al link del libro-->
                <div class="contact">
                    <a href="https://www.instagram.com/chantix_04/">Más Info</a>
                </div>
            </div>
    <!--footer-->
